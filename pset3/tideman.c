...
void lock_pairs(void)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        cycle1 = false;
        cycle2 = false;
        for (int j = 0; j < candidate_count; j++) //if a loser gonna be a winner over a winer, cycle;
        {
            if (locked[j][pairs[i].winner] == true) //is a loser? 
            {
                cycle1 = true;
                break;
            }
        ...
        for (int j = 0; j < candidate_count; j++)
        {
            if (locked[pairs[i].loser][j] == true) //over a winner?
            {
                cycle2 = true;
                break;
            }
